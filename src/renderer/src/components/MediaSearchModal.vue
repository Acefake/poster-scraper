<template>
  ...
  >
    ...
    <div class="max-h-[80vh] overflow-y-auto">
      <div v-if="results.length === 0 && !isSearching" class="text-center py-8 text-gray-500">
        <p>没有搜索结果</p>
      ...
      <div v-else class="grid grid-cols-5 gap-4 my-5">
        ...
        >
          <div class="relative overflow-hidden rounded-t-xl">
            ...
            />
            <div v-else class="h-56 w-full bg-gray-700/30 flex items-center justify-center">
              <span class="text-gray-400 text-sm">无海报</span>
            </div>
            <!-- 评分角标 -->
            <div v-if="item.vote_average" class="absolute top-2 right-2 flex items-center gap-0.5 bg-black/60 backdrop-blur-sm rounded-md px-1.5 py-0.5 text-[11px] text-yellow-400 font-medium">
          ...
          <div class="p-3">
            ...
            <button
              ...
              :class="{ 'opacity-60 pointer-events-none': loadingId === item.id }"
