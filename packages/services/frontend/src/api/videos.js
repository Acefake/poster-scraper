...
const API_BASE = 'http://localhost:31471'

export const proxyImg = (url) => url ? `${API_BASE}/proxy?url=${encodeURIComponent(url)}` : ''
...
export default {
    ...
    async getMeta(id) {
        const response = await axios.get(`${API_BASE}/api/meta/${id}`)
